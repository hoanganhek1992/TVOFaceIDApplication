...
public class TimeKeepingActivity extends AppCompatActivity {
    ...
    TextView currentLocation, currentDistance, currentTime;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        currentDistance = findViewById(R.id.txtDistance);
            ...
            public void onLocationResult(LocationResult locationResult) {
                ...
                if (location != null) {
                    if (mCount < mMaxRepeat) {
                        if (calculateDistance(mResourceLocation, location) < 1000) {
                            stopLocationUpdates();
                            mCount = 0;
                            progressDialog.dismiss();
                            currentDistance.setText("Thanh cong");
                        } else {
                            mCount++;
                        }
                    } else {
